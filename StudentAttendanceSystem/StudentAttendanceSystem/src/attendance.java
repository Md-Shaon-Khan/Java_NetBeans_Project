...
//        Logger.getLogger(sheet.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        a_stuname = new javax.swing.JTextField();
        a_stuid = new javax.swing.JTextField();
        ...
        jLabel14.setText("Attendance Sheet");
        ...
        a_stuname.setForeground(new java.awt.Color(204, 204, 204));

        a_stuid.setForeground(new java.awt.Color(204, 204, 204));
        ...
        report.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
                    ...
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel12Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(a_stuname, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel12Layout.createSequentialGroup()
                                .addComponent(jLabel18, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(a_stuid, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(submit, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(report, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(a_stuname, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel18)
                            .addComponent(a_stuid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        table2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 102), 3));
...
//            dateString2 = sdf.format(date2.getDate()).replace("-", "_"); // Replace '-' with '_'
//        } else {
...
//            ResultSet columns = dbMeta.getColumns(null, null, "stu_atten", dateString2);
//
//            if (!columns.next()) {
//                // Correct backtick usage and removed extra spaces
//                String addColumnSQL = "ALTER TABLE stu_atten ADD `" + dateString2 + "` INT DEFAULT 0";
//                pst = con.prepareStatement(addColumnSQL);
//                pst.executeUpdate();
//            }
//
//            int checkboxColumnIndex = table2.getColumnCount() - 1;
//            for (int row = 0; row < table2.getRowCount(); row++) {
//                Boolean isChecked = (Boolean) table2.getValueAt(row, checkboxColumnIndex);
//                int attendanceValue = isChecked != null && isChecked ? 1 : 0;
//
//                String id = (String) table2.getValueAt(row, 0);
//                String name = (String) table2.getValueAt(row, 1);
//
//                // Corrected backtick placement for column names
//                String insertOrUpdateSQL = "INSERT INTO stu_atten (ID, Name, `" + dateString2 + "`) "
//                        + "VALUES (?, ?, ?) "
//                        + "ON DUPLICATE KEY UPDATE `" + dateString2 + "` = ?";
...
//            }
//
//            JOptionPane.showMessageDialog(null, "Attendance updated successfully on " + dateString2);
//        } catch (SQLException ex) {
...
//        }
    ...
    private javax.swing.JTextField a_stuid;
    private javax.swing.JTextField a_stuname;
